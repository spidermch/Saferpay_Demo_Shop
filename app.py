...
SAFERPAY_FEATURE_AUDIT = [
    ...
    {'name': 'Transaction Management', 'features': [
        ...
        {'id': 'cancel', 'name': 'Transaction Cancel', 'endpoint': 'Payment/v1/Transaction/Cancel', 'implemented': False,
         ...
         'activation_note': 'Available with all Saferpay licenses. No special activation needed - just implement the API call.'},
        {'id': 'refund', 'name': 'Transaction Refund', 'endpoint': 'Payment/v1/Transaction/Refund', 'implemented': False,
         ...
         'activation_note': 'Available with all Saferpay licenses. Refund rights may need to be configured per terminal in Saferpay Backoffice.'},
        {'id': 'multipart', 'name': 'Multipart Capture', 'endpoint': 'Payment/v1/Transaction/MultipartCapture', 'implemented': False,
         ...
         'activation_note': 'Requires Saferpay Business license. Must be enabled per terminal in Saferpay Backoffice.'},
    ]},
    {'name': 'Tokenization & Recurring', 'features': [
        {'id': 'alias_insert', 'name': 'Alias/Insert', 'endpoint': 'Payment/v1/Alias/Insert', 'implemented': False,
         ...
         'activation_note': 'Requires Secure Card Data (SCD) module activation. Available as add-on to any Saferpay license. Contact sales to activate.'},
        {'id': 'alias_assert', 'name': 'Alias/AssertInsert', 'endpoint': 'Payment/v1/Alias/AssertInsert', 'implemented': False,
         ...
         'activation_note': 'Part of Secure Card Data module. Activate SCD first in Saferpay Backoffice.'},
        {'id': 'alias_delete', 'name': 'Alias/Delete', 'endpoint': 'Payment/v1/Alias/Delete', 'implemented': False,
         ...
         'activation_note': 'Part of Secure Card Data module. Activate SCD first.'},
        {'id': 'auth_ref', 'name': 'AuthorizeReferenced', 'endpoint': 'Payment/v1/Transaction/AuthorizeReferenced', 'implemented': False,
         ...
         'activation_note': 'Requires Secure Card Data for stored aliases AND Transaction Interface license. Contact sales.'},
    ]},
    {'name': 'Secure Fields', 'features': [
        {'id': 'sf_init', 'name': 'Secure Fields Initialize', 'endpoint': 'Payment/v1/Transaction/Initialize', 'implemented': False,
         ...
         'activation_note': 'Requires Transaction Interface license (Saferpay Business or higher). PCI SAQ-A compliance needed.'},
        {'id': 'sf_auth', 'name': 'Secure Fields Authorize', 'endpoint': 'Payment/v1/Transaction/Authorize', 'implemented': False,
         ...
         'activation_note': 'Part of Transaction Interface. Same requirements as Secure Fields Initialize.'},
    ]},
    {'name': 'Batch & Reporting', 'features': [
        {'id': 'batch', 'name': 'Batch/Close', 'endpoint': 'Payment/v1/Batch/Close', 'implemented': False,
         ...
         'activation_note': 'Available with all licenses. Terminal must be configured for manual batch close in Backoffice.'},
        {'id': 'inquire', 'name': 'Transaction Inquire', 'endpoint': 'Payment/v1/Transaction/Inquire', 'implemented': False,
         ...
         'activation_note': 'Available with all Saferpay licenses. No special activation needed.'},
    ]},
    {'name': 'Risk & 3-D Secure', 'features': [
        ...
        {'id': 'risk', 'name': 'Risk Information', 'endpoint': None, 'implemented': False,
         ...
         'activation_note': 'Available with all licenses. Enhanced risk scoring may require Saferpay Business license.'},
    ]},
    {'name': 'OmniChannel', 'features': [
        {'id': 'omni_acquire', 'name': 'OmniChannel AcquireTransaction', 'endpoint': 'Payment/v1/OmniChannel/AcquireTransaction', 'implemented': False,
         'description': 'Transfer a POS transaction to e-commerce for further processing (capture, refund). Bridges physical and online channels.',
         'activation_note': 'Requires a Worldline Omni-Channel contract and compatible POS device. Contact your Worldline account manager to activate.'},
        {'id': 'omni_alias', 'name': 'OmniChannel InsertAlias', 'endpoint': 'Payment/v1/OmniChannel/InsertAlias', 'implemented': False,
         'description': 'Store card details from a POS transaction as an alias in Secure Card Data for future e-commerce use.',
         'activation_note': 'Requires Omni-Channel contract, Secure Card Data activation, and compatible POS device. Not supported for UnionPay, WeChat Pay, or TWINT.'},
    ]},
    {'name': 'Mail / Phone Order (MOTO)', 'features': [
        {'id': 'moto', 'name': 'MOTO Transactions', 'endpoint': 'Payment/v1/Transaction/Initialize (MOTO terminal)', 'implemented': False,
         'description': 'Process card-not-present transactions where card details are provided by phone or mail.',
         'activation_note': 'Requires a dedicated MOTO terminal in Saferpay Backoffice. Merchant needs SAQ-A EP level PCI certification for API integration. No 3DS or DCC available for MOTO. Alternative: use Saferpay Backoffice built-in MOTO feature.'},
    ]},
]
